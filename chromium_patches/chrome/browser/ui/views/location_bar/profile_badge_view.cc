diff --git a/chrome/browser/ui/views/location_bar/profile_badge_view.cc b/chrome/browser/ui/views/location_bar/profile_badge_view.cc
new file mode 100644
index 0000000000000..def1234567890
--- /dev/null
+++ b/chrome/browser/ui/views/location_bar/profile_badge_view.cc
@@ -0,0 +1,137 @@
...
+  // Note: This is a simple byte-based truncation. For proper Unicode handling,
+  // use base::TruncateUTF8ToByteSize or ICU truncation.
