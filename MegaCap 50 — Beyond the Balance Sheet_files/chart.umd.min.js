...
!((t, e) => {
  ...
  class bn {
    constructor(t) {
      ;(this._config = ((t) => (((t = t || {}).data = un(t.data)), dn(t), t))(
        t,
      )),
  ...
  function qo(t) {
    ...
    return (i, s) => {
      ...
      n instanceof jn
        ? (e = ((t, e) => ((t.backgroundColor = t.data.map(() => Uo(e++))), e))(
            i,
            e,
          ))
        : n instanceof $n
          ...
          : n &&
            (e = ((t, e) => (
              (t.borderColor = Uo(e)), (t.backgroundColor = Xo(e)), ++e
            ))(i, e))
    }
  }
  function Ko(t) {
