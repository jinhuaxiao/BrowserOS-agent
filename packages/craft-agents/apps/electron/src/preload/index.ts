...
const api: ElectronAPI = {
  ...
  onUpdateDownloadProgress: (callback: (progress: number) => void) => {
    ...
    return () =>
      ipcRenderer.removeListener(IPC_CHANNELS.UPDATE_DOWNLOAD_PROGRESS, handler)
  },
  ...
  importCliCredentials: () =>
    ipcRenderer.invoke(IPC_CHANNELS.ONBOARDING_IMPORT_CLI_CREDENTIALS),
  ...
  updateApiSetup: (
    ...
    ipcRenderer.invoke(
      IPC_CHANNELS.SETTINGS_UPDATE_API_SETUP,
      authType,
      credential,
      anthropicBaseUrl,
      customModel,
  ...
  testApiConnection: (apiKey: string, baseUrl?: string, modelName?: string) =>
    ipcRenderer.invoke(
      IPC_CHANNELS.SETTINGS_TEST_API_CONNECTION,
      apiKey,
      baseUrl,
      modelName,
    ),
  ...
  setGitBashPath: (path: string) =>
    ipcRenderer.invoke(IPC_CHANNELS.GITBASH_SET_PATH, path),

  // Browser Profiles
  listBrowserProfiles: () =>
    ipcRenderer.invoke(IPC_CHANNELS.BROWSER_PROFILES_LIST),
  ...
  updateBrowserProfile: (
    profileId: string,
    input: import('../shared/types').UpdateProfileInput,
  ) =>
  ...
  updateProxy: (
    proxyId: string,
    input: import('../shared/types').UpdateProxyInput,
  ...
  updateProfileGroup: (
    groupId: string,
    input: import('../shared/types').UpdateGroupInput,
  ...
  createProfileFromTemplate: (
    templateId: string,
    overrides?: Partial<import('../shared/types').CreateProfileInput>,
  ) =>
    ipcRenderer.invoke(
  ...
  // Migration
  migrateToProxyPool: () =>
    ipcRenderer.invoke(IPC_CHANNELS.BROWSER_PROFILES_MIGRATE),
  needsProxyPoolMigration: () =>
    ipcRenderer.invoke(IPC_CHANNELS.BROWSER_PROFILES_NEEDS_MIGRATION),

  // Browser Settings
  getBrowserSettings: () =>
    ipcRenderer.invoke(IPC_CHANNELS.BROWSER_SETTINGS_GET),
  setBrowserSettings: (
    path: string,
    options?: { browserType?: string; useCustomPathOnly?: boolean },
  ) => ipcRenderer.invoke(IPC_CHANNELS.BROWSER_SETTINGS_SET, path, options),
  clearBrowserSettings: () =>
    ipcRenderer.invoke(IPC_CHANNELS.BROWSER_SETTINGS_CLEAR),
  ...
  menuToggleDevTools: () =>
    ipcRenderer.invoke(IPC_CHANNELS.MENU_TOGGLE_DEVTOOLS),
