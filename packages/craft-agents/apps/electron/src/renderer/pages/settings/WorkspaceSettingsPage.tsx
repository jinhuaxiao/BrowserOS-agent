              ...
              <SettingsSection title="Workspace Info">
                <SettingsCard>
                  ...
                  >
                    ...
                    >
                      {isUploadingIcon ? (
                        <Spinner className="text-foreground/50 text-[8px]" />
                      ) : wsIconUrl ? (
                        <img
                          src={wsIconUrl}
                          alt=""
                      ...
                      <div className="flex items-center gap-2">
                        {workingDirectory && (
                          <button
                            ...
                            className="inline-flex items-center h-8 px-3 text-sm rounded-lg bg-background shadow-minimal hover:bg-foreground/[0.02] transition-colors text-foreground/50 hover:text-foreground"
                          >
                            Clear
                          </button>
                        )}
