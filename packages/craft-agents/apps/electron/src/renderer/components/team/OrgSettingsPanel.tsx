          ...
          <label className="mb-1 block font-medium text-sm">
            ...
            <div className="flex gap-2">
              <input
                ...
                disabled={!canEdit}
                className="flex-1 rounded-md border border-border bg-transparent px-3 py-2 text-sm focus:border-foreground focus:ring-1 focus:ring-foreground focus:outline-none disabled:opacity-50"
              />
