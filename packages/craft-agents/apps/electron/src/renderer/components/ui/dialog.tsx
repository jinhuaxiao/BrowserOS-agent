...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn('text-lg leading-none font-serif font-medium', className)}
      {...props}
    />
  )
}
