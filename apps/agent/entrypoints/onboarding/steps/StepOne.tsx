      ...
      <div className="space-y-8">
        ...
        <div className="flex items-center justify-center gap-6 py-6">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="flex h-16 w-16 items-center justify-center rounded-xl shadow-xl">
              <img src={NovaLogo} alt="Nova Seller" className="h-full w-full" />
            </div>
            <span className="font-medium text-accent-brand text-xs">
              Nova Seller
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="group relative overflow-hidden rounded-lg border border-border bg-card/50 p-4 transition-all hover:border-[var(--accent-brand)]/50 hover:bg-card">
            ...
            <Upload className="mb-2 h-5 w-5 text-[var(--accent-brand)]" />
          ...
          <div className="group relative overflow-hidden rounded-lg border border-border bg-card/50 p-4 transition-all hover:border-[var(--accent-brand)]/50 hover:bg-card">
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--accent-brand)]/0 to-[var(--accent-brand)]/5 opacity-0 transition-opacity group-hover:opacity-100" />
            <Clock className="mb-2 h-5 w-5 text-[var(--accent-brand)]" />
          ...
          <div className="group relative overflow-hidden rounded-lg border border-border bg-card/50 p-4 transition-all hover:border-[var(--accent-brand)]/50 hover:bg-card">
            <div className="absolute inset-0 bg-gradient-to-br from-[var(--accent-brand)]/0 to-[var(--accent-brand)]/5 opacity-0 transition-opacity group-hover:opacity-100" />
            <Key className="mb-2 h-5 w-5 text-[var(--accent-brand)]" />
        ...
        <div className="flex flex-col items-center gap-3 pt-2">
          <Button
            ...
            className="h-10 bg-brand-gradient text-white shadow-[var(--accent-brand)]/25 shadow-lg hover:opacity-90"
          >
          ...
          <p className="text-center text-muted-foreground text-xs">
            ...
            >
              <code className="rounded bg-muted px-1.5 py-0.5 font-mono text-[var(--accent-brand)]">
                {importSettingsURL}
              </code>
            </button>
          </p>
